...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["form_type"]) && $_POST["form_type"] == "trabalhe") {
    ...
    $allowed_cargos = [
        '1/2 OFICIAL',
        'AJUDANTE DE LIMPEZA RADIOLOGICA',
        'AJUDANTE I',
        'ALMOXARIFE',
        'ANALISTA DE DEPARTAMENTO PESSOAL',
        'ANALISTA DE LICITACAO',
        ...
        'AUX. DE ADMINISTRACAO',
        'AUX. SERV. GERAIS - LIMPEZA DE VALA',
        'AUX.SERV.GERAIS I',
        ...
        'COODENADOR TECNICO DE MEIO AMBIENTE',
        'EDUCADOR SOCIAL',
        'ELETRICISTA I',
        'ENCARREGADO',
        'ENCARREGADO DE TURMA',
        'ENCARREGADO GERAL',
        'ENCARREGADO TECNICO RADIOLOGICO',
        'ENGENHEIRO CIVIL',
        ...
        'MESTRE DE OBRAS',
        'MOTORISTA',
        'OFICIAL DE LIMPEZA RADIOLOGICA',
        'OPERADOR DE ESCAVADEIRA HIDRAULICA',
        'OPERADOR DE MAQUINAS',
        'OPERADOR DE MICRO MOTOR',
        ...
        'SUPERVISOR',
        'SUPERVISOR DE OBRA',
        'SUPERVISOR TECNICO RADIOLOGICO',
